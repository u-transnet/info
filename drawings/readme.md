В этой папке хранятся диаграммы и модели главным образом в формате draw.io . Чтобы открыть файл, находящийся в этой папке, нужно сформировать ссылку в формате 
